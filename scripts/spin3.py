...
# Initial state
rho0 = tensor([fock(2, 1), fock(2, 0), fock(2, 0)])

# Define Lindblad operator and collapse operators
L = np.sqrt(gamma) * sigmaz_list[1]
c_ops = []
sc_ops = [L]
